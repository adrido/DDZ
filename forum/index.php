...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="de" lang="de">
	<head>
		...
		<script language="javascript"><!--language ist veraltet!!!! staddessen type="text/javascript"verwenden! -->
			AC_FL_RunContent = 0;
		</script>
...
<body>
		...
		<div id="Gesamt">
				...
				<div id="flash">
					...
					<noscript>
						<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="220" height="220" id="Ringschrift-flash" align="middle">
							...
							<embed src="../Ringschrift-flash.swf" quality="high" wmode="transparent" bgcolor="#ffffff" width="220" height="220" name="Ringschrift-flash" align="middle" allowScriptAccess="sameDomain" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
						</object>
					</noscript>
				</div>
			</div>
			...
			<div id="unter_login">
				<a href="index.php?seite=anmelden">Registrieren</a></br>
			</div>
			<div id="willkommen">
